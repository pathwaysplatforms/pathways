...
const ROUTE_GROUPS: RouteGroup[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      { path: "/dashboard/application", label: "/dashboard/application" },
      { path: "/dashboard/documents", label: "/dashboard/documents" },
      { path: "/dashboard/profile", label: "/dashboard/profile" },
      { path: "/dashboard/crs", label: "/dashboard/crs" },
      { path: "/dashboard/ask", label: "/dashboard/ask" },
